...
def pppoe_stats
  ...
  def destroy
    ...
    if @subscription.service_type == 'dhcp'
      ...
      RadReply.where(username: @subscription.mac_address, radiusattribute: 'Framed-IP-Address').destroy_all
RadUserGroup.where(username: @subscription.mac_address, groupname: @subscription.package).destroy_all
RadCheck.where(username: @subscription.mac_address, radiusattribute: 'Expiration').destroy_all
 ...
 if  use_autogenerated_number_as_ppoe_password
      RadReply.where(username: @subscription.ppoe_password,
       radiusattribute: 'Framed-IP-Address'
       ).destroy_all
 ...
 if  !use_autogenerated_number_as_ppoe_username && !use_autogenerated_number_as_ppoe_password
      RadReply.where(username: @subscription.ppoe_username,
       radiusattribute: 'Framed-IP-Address'
       ).destroy_all
  ...
  if  use_autogenerated_number_as_ppoe_password
    rad_reply = RadReply.find_or_initialize_by(username: pppoe_password,
     radiusattribute: 'Framed-IP-Address')
