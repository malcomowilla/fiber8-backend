...
def set_current_tenant
  ...
  use_autogenerated_number_as_ppoe_username = ActsAsTenant.current_tenant.subscriber_setting.use_autogenerated_number_as_ppoe_username
      ...
      use_autogenerated_number_as_ppoe_username && user_group = RadUserGroup.find_or_initialize_by(username: pppoe_username)
      use_autogenerated_number_as_ppoe_password && user_group = RadUserGroup.find_or_initialize_by(username: pppoe_password)
