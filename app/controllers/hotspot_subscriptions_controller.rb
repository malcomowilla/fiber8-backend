...
session = RadAcct.where(framedipaddress: params[:ip], framedprotocol: '').order(acctupdatetime: :desc).first ||
          RadAcct.where(callingstationid: params[:mac], framedprotocol: '', ).order(acctupdatetime: :desc).first
