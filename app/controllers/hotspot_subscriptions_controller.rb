...
session = RadAcct.where(callingstationid: mac, framedprotocol: '', ).order(acctupdatetime: :desc).first ||
          
           RadAcct.where(framedipaddress: ip, framedprotocol: '').order(acctupdatetime: :desc).first 
