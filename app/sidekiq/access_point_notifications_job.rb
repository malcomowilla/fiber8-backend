...
notification_when_unreachable = tenant&.access_point_setting&.notification_when_unreachable
# unreachable_duration_minutes = tenant&.nas_setting&.unreachable_duration_minutes
notification_phone_number = tenant&.access_point_setting&.notification_phone_number
...
if notification_when_unreachable
  ...
  reachable = tcp_reachable?(ip_address, 80)
...
api_secret_api_key = tenant&.sms_setting
  ...
  api_secret = api_secret_api_key&.api_secret
    ...
    original_message =  "Hello, your acess point=> #{ip_address}, router name=>#{router_name} is unreachable"
