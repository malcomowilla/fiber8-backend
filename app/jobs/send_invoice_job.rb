...
send_sms_for_tenant(company_name, phone_number, package_amount,
  ...
  def send_sms_for_tenant(company_name, phone_number, package_amount,
    ...
    when "Talk Sasa"
      send_invoice_talksasa(company_name, phone_number, package_amount,
     due_date, paybill, account_no, tenant)
  ...
  def send_invoice_talksasa(company_name, phone_number, package_amount,
     due_date, paybill, account_no, tenant)
  ...
  original_message = "Invoice for amount #{package_amount} KSh has been created For your #{company_name || 'Aitechs'} internet service. Due date: #{due_date},
