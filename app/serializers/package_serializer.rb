class PackageSerializer < ActiveModel::Serializer
  attributes :id, :name, :price, :download_limit, :upload_limit,
   :account_id, :tx_rate_limit,
   :rx_rate_limit, :validity_period_units, :download_burst_limit, 
   :upload_burst_limit,
    ...
    :aggregation, :subscription, :daily_charge, :fup_enabled
  ...
  def subscription
  Subscription.where(package_name: self.object.name).count
end
