...
class GeneralSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create general_setting" do
    assert_difference("GeneralSetting.count") do
      post general_settings_url, params: { general_setting: { account_id: @general_setting.account_id, allowed_ips: @general_setting.allowed_ips, timezone: @general_setting.timezone, title: @general_setting.title } }
    end
  ...
  test "should update general_setting" do
    patch general_setting_url(@general_setting), params: { general_setting: { account_id: @general_setting.account_id, allowed_ips: @general_setting.allowed_ips, timezone: @general_setting.timezone, title: @general_setting.title } }
