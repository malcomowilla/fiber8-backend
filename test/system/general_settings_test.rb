...
class GeneralSettingsTest < ApplicationSystemTestCase
  ...
  test "should create general setting" do
    ...
    fill_in "Account", with: @general_setting.account_id
    fill_in "Allowed ips", with: @general_setting.allowed_ips
    fill_in "Timezone", with: @general_setting.timezone
    fill_in "Title", with: @general_setting.title
