...
ActiveRecord::Schema[7.2].define(version: 2026_09_11_202408) do
  ...
  create_table "ad_settings", force: :cascade do |t|
    ...
    t.string "ad_format", default: "image"
  ...
  create_table "grace_period_settings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "sla_threshold_hours", default: 24, null: false
  ...
  create_table "hotspot_templates", force: :cascade do |t|
    ...
    t.boolean "premium"
    t.string "location"
    t.index ["account_id"], name: "index_hotspot_templates_on_account_id"
  end
  ...
  create_table "incidents", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "expired_lookback_days", default: 3, null: false
  ...
  create_table "payment_gateway_settings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "use_case"], name: "index_payment_gateway_settings_on_account_id_and_use_case", unique: true
    t.index ["account_id"], name: "index_payment_gateway_settings_on_account_id"
  end

  create_table "paystack_settings", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.string "public_key"
    t.string "secret_key"
    t.boolean "enabled", default: false, null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "wallet_pin"
    t.string "withdrawal_otp"
    t.datetime "withdrawal_otp_sent_at"
    t.boolean "wallet_admin", default: false
    t.index ["email"], name: "index_users_on_email"
  end

  create_table "wallet_audits", force: :cascade do |t|
    t.string "admin"
    t.string "amount"
    t.string "ip_address"
    t.string "action"
