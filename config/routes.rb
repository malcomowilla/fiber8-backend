...
resources :nas_routers, path: 'nas_routers' do
  ...
  get    '/api/hotspot/portal/my_devices',         to: 'hotspot_portal#my_devices'
  get    '/api/hotspot/portal/payments',           to: 'hotspot_portal#payments'
  patch  '/api/hotspot/portal/devices/:id/replace', to: 'hotspot_portal#replace_device'
  post '/api/hotspot/portal/login', to: 'hotspot_portal#login'
...
delete '/api/payment_gateway_pin',        to: 'payment_gateway_pin#destroy'
get    '/api/server_time',                to: 'server_time#show'
...
post '/api/hotspot_packages/bulk_sync_to_mikrotik', to:  "hotspot_packages#bulk_sync_to_mikrotik"
post '/hotspot_packages/bulk_sync_to_mikrotik', to: "hotspot_packages#bulk_sync_to_mikrotik"
...
get '/allow_get_ads', to: 'ad_settings#allow_get_ads'
...
get '/get_ad_settings_by_id', to: 'ad_settings#get_ad_settings_by_id'
...
get '/get_hotspot_and_dial_plan', to: 'hotspot_and_dial_plans#get_current_hotspot_and_dial_plan'
...
# post 'hotspot_payment_url', to: 'confirm_payment#confirmation_url'
#  post 'hotspot_payment_url', to: 'confirm_payment#check_payment_status'
...
post "sasapay_payments", to: 'hotspot_vouchers#check_payment_status'
...
get '/get_total_bandwidth_and_online_users', to: 'subscriptions#get_total_bandwidth_and_online_users'
...
post '/api/unbock_service', to: 'subscriptions#unbock_service'
...
patch '/update_package/:id', to: 'packages#update'
patch '/api/update_package/:id', to: 'packages#update'
